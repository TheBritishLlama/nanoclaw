...
function handleRating(
  ...
  try {
    updateDropRating(path.join(vaultPath, row.vault_path), { rating: rating.rating, feedback: rating.feedback, ratedAt });
  } catch {
...
async function handleLearn(
  gmail: GmailSender, addrs: { from: string; to: string }, term: string, _insist: boolean,
): Promise<InboundResult> {
